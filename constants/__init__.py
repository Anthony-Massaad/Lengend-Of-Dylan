...
entity_data = {
    ...
    'player': {StatsName.HEALTH.value: 100, StatsName.DEFENSE.value: 25, StatsName.ATTACK.value: 25, StatsName.MANA_ATTACK.value: 5, StatsName.MANA.value: 100, StatsName.SPEED.value: 300}
}
